...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle(10)).toHaveProperty('area', 314);
    expect(circle(10)).toHaveProperty('radius');
    expect(circle(10)).toHaveProperty('area');
    expect(circle(10)).toHaveProperty('circumference');
